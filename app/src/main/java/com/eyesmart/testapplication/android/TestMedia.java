...
public class TestMedia {
     ...
     * 不支持多个音频同时播放
     */
    public static void playSoundByMedia() throws IOException {
        ...
        //装载
//        mediaPlayer.setDataSource(applicationContext, Uri.parse("http://www.crazyit.org/abc.mp3"));//可以装载网络音频文件
//        AssetFileDescriptor fd = applicationContext.getResources().openRawResourceFd(R.raw.test);
...
//        fd.close();
    ...
    public static void playSound(int rawId) {
        ...
        soundMap.put(R.raw.test, soundPool.load(applicationContext, R.raw.test, 1));//1为优先级（目前无作用）
        //播放是异步方式，不会阻塞主线程
